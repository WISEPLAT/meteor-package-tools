Package.describe({
  ...
  version: '0.7.0',
  git: 'http://github.com/wiseplat/meteor-package-tools'
});
...
Package.onUse(function(api) {
  ...
  api.export(['WshTools'], ['client', 'server']);


  api.addFiles('wshtools.js', ['client', 'server']);
...
Package.onTest(function(api) {
  api.use('tinytest');
  api.use('wiseplat:tools');
  api.addFiles('wshtools-tests.js', ['client', 'server']);
});
